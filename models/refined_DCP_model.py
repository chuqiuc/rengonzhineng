import torch
import itertools
from util1.image_pool import ImagePool
...
class RefinedDCPModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--netR_T', type=str, default='Reslike', help='specify generator architecture')
